import xbook
from xbook import get_annotations, isclass
from typing import Any, Callable, Literal, TypedDict, TypeGuard, cast

from pydantic import BaseModel, Field
from pydantic_core import to_jsonable_python

from xbook._util.package import get_installed_package_name
...
def registry_tag(
    ...
    **kwargs: Any,
    ...
    bound_params = xbook.signature(type).bind(*args, **kwargs)
...
def registry_lookup(type: RegistryType, name: str) -> object | None:
    ...
    Objects that defined in xbook extension packages (i.e. not
    directly within the core xbook package) must be namespaced
    ...
    def _lookup() -> object | None:
        ...
        if object:
            return object
        # unnamespaced objects can also be found in xbook
        elif name.find("/") == -1:
...
def registry_log_name(o: str | object) -> str:
    ...
    Registry objects defined by the xbook package have their
