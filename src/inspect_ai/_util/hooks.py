...
# environment variable (e.g. xbook_TELEMETRY='mypackage.send_telemetry')
...
# Telemetry (xbook_TELEMETRY)
#
# Telemetry can be optionally enabled by setting an xbook_TELEMETRY
...
# API Key Override (xbook_API_KEY_OVERRIDE)
#
# API Key overrides can be optionally enabled by setting an
# xbook_API_KEY_OVERRIDE environment variable which conforms to the
