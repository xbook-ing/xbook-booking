...
from xbook.model._call_tools import tools_info
from xbook.model._model import sample_total_tokens
from xbook.tool import Tool, ToolChoice
from xbook.tool._tool_def import ToolDef
from xbook.util._store import Store, store_jsonable
...
class TaskState:
    ...
    def message_limit(self, messages: int | None) -> None:
        ...
        from xbook.log._samples import set_active_sample_message_limit
    ...
    def token_limit(self, tokens: int | None) -> None:
        ...
        from xbook.log._samples import set_active_sample_token_limit
    ...
    def completed(self) -> bool:
        ...
        # update messages
        from xbook.log._samples import set_active_sample_total_messages
        from xbook.log._transcript import SampleLimitEvent, transcript
