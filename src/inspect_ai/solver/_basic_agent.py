...
from xbook.model._cache import CachePolicy
from xbook.model._call_tools import call_tools
from xbook.model._chat_message import ChatMessageTool, ChatMessageUser
from xbook.model._model import get_model
from xbook.scorer._metric import Score, ValueToFloat, value_to_float
from xbook.scorer._score import score
from xbook.solver._chain import chain
from xbook.tool._tool import Tool, ToolResult, tool
        ...
        async def solve(state: TaskState, generate: Generate) -> TaskState:
            ...
            while not state.completed:
                ...
                if state.output.stop_reason == "model_length":
                    from xbook.log._transcript import transcript
