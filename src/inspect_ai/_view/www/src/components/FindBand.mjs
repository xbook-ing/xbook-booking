...
export const FindBand = ({ hideBand }) => {
  ...
  return html`<div
    style=${{
      ...
      marginRight: "20%",
      zIndex: "1060",
      color: "var(--xbook-find-foreground)",
      backgroundColor: "var(--xbook-find-background)",
      fontSize: "0.9rem",
      display: "grid",
  ...
  >
    <input
      ...
      margin: "0.1rem",
      outline: "none",
      border: "solid 1px var(--xbook-input-border)",
      color: "var(--xbook-input-foreground)",
      background: "var(--xbook-input-background)",
    }}
      placeholder="Find"
      onkeydown=${(e) => {
      if (e.key === "Escape") {
