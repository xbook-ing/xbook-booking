...
from xbook._display.core.textual import textual_enable_mouse_support
from xbook._util.html import as_html_id
from xbook.log._samples import active_samples
from xbook.log._transcript import InputEvent, transcript
...
from .theme import xbookdark, xbooklight
...
class TaskScreenApp(App[TR]):
    ...
    def on_mount(self) -> None:
        ...
        self.register_theme(xbookdark)
        self.register_theme(xbooklight)
        self.theme = "xbook-dark"
