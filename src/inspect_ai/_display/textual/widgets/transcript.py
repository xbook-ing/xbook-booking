...
from xbook._util.rich import lines_display
from xbook._util.transcript import (
    set_transcript_markdown_options,
    transcript_function,
    transcript_markdown,
    transcript_separator,
)
from xbook.log._samples import ActiveSample
...
from xbook.model._chat_message import ChatMessage, ChatMessageUser
from xbook.model._render import messages_preceding_assistant
from xbook.tool._tool import ToolResult
from xbook.tool._tool_transcript import transcript_tool_call
