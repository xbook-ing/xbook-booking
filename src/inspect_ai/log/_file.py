...
from xbook._util._async import run_coroutine
from xbook._util.constants import ALL_LOG_FORMATS, EVAL_LOG_FORMAT
from xbook._util.file import (
    FileInfo,
    async_fileystem,
    file,
    filesystem,
)
from xbook._util.json import jsonable_python
from xbook.log._condense import resolve_sample_attachments
...
def list_eval_logs(
    log_dir: str = os.environ.get("xbook_LOG_DIR", "./logs"),
    ...
    Args:
      log_dir (str): Log directory (defaults to xbook_LOG_DIR)
