...
def bundle_log_dir(
    ...
    Args:
        ...
        output_dir: (str | None): The directory to place bundled output. If no directory
            is specified, the env variable `xbook_VIEW_BUNDLE_OUTPUT_DIR` will be used.
    ...
    output_dir = (
        output_dir if output_dir else os.getenv("xbook_VIEW_BUNDLE_OUTPUT_DIR", "")
    )
    if output_dir == "":
