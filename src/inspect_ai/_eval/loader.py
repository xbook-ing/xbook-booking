...
from xbook._eval.task.util import task_file, task_run_dir
from xbook._util.decorator import parse_decorators
from xbook._util.error import PrerequisiteError
from xbook._util.logger import warn_once
from xbook._util.path import chdir_python
...
from xbook.model import Model, ModelName
from xbook.solver._solver import Solver, SolverSpec
from xbook.util import SandboxEnvironmentSpec, SandboxEnvironmentType
from xbook.util._sandbox.environment import resolve_sandbox_environment
...
def load_module(
    ...
    if module_path.suffix == ".py":
        ...
        try:
            from xbook._util.notebook import NotebookLoader
        except ImportError:
            return None
