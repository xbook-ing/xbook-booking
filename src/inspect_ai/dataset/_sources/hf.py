...
from xbook._util.appdirs import xbookcache_dir
from xbook._util.error import pip_dependency_error
from xbook._util.file import safe_filename
from xbook._util.hash import mm3_hash
...
def hf_dataset(
    ...
    **kwargs: Any,
    ...
    datasets_cache_dir = xbookcache_dir("hf_datasets")
