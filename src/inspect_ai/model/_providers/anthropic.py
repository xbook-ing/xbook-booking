...
from xbook._util.constants import BASE_64_DATA_REMOVED, DEFAULT_MAX_RETRIES
from xbook._util.content import Content, ContentText
...
from xbook._util.url import data_uri_mime_type, data_uri_to_base64, is_data_uri
from xbook.tool import ToolCall, ToolChoice, ToolFunction, ToolInfo
...
async def resolve_chat_input(
    ...
    # collapse user messages (as xbook 'tool' messages become Claude 'user' messages)
