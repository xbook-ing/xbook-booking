...
from xbook._util.constants import DEFAULT_MAX_TOKENS
    ...
    def hf_chat(self, messages: list[ChatMessage], tools: list[ToolInfo]) -> str:
        ...
        if len(tools) > 0:
            ...
            if "mistral" in self.model_name.lower():
                ...
                hf_messages = xbooktools_to_string(hf_messages)
...
def xbooktools_to_string(messages: list[ChatMessage]) -> list[ChatMessage]:
