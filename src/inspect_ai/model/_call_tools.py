...
from xbook._util.text import truncate_string_to_bytes
from xbook.model._trace import trace_tool_mesage
from xbook.tool import Tool, ToolCall, ToolError, ToolInfo
from xbook.tool._tool import (
    ToolApprovalError,
    ToolParsingError,
)
from xbook.tool._tool_call import ToolCallContent, ToolCallError
from xbook.tool._tool_def import ToolDef, tool_defs
from xbook.tool._tool_info import parse_docstring
from xbook.tool._tool_params import ToolParams
from xbook.util import OutputLimitExceededError
...
async def call_tool(tools: list[ToolDef], message: str, call: ToolCall) -> Any:
    ...
    from xbook.approval._apply import apply_tool_approval
...
def tool_params(input: dict[str, Any], func: Callable[..., Any]) -> dict[str, Any]:
    ...
    signature = xbook.signature(func)
    type_hints = get_type_hints(func)
    docstring = xbook.getdoc(func)
