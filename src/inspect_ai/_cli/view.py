...
from xbook._util.constants import DEFAULT_SERVER_HOST, DEFAULT_VIEW_PORT
from xbook._view.view import view
...
def start(
    ...
    **common: Unpack[CommonOptions],
    ...
    xbook_VIEW_AUTHORIZATION_TOKEN = "xbook_VIEW_AUTHORIZATION_TOKEN"
    authorization = os.environ.get(xbook_VIEW_AUTHORIZATION_TOKEN, None)
    if authorization:
        del os.environ[xbook_VIEW_AUTHORIZATION_TOKEN]
        os.unsetenv(xbook_VIEW_AUTHORIZATION_TOKEN)
