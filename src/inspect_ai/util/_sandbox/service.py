...
SERVICES_DIR = "/tmp/xbook-sandbox-services"
...
class SandboxService:
    ...
    for calling back into the main xbook process.
    ...
    ```python
    import sys
    sys.path.append("/tmp/xbook-sandbox-services/foo")
    import foo
    ```
    ...
    spec = importlib.util.spec_from_file_location(
        "foo", "/tmp/xbook-sandbox-services/foo/foo.py"
    )
