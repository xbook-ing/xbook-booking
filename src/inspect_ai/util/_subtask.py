...
from xbook._util._async import is_callable_coroutine
from xbook._util.content import Content
from xbook.util._store import Store, dict_jsonable, init_subtask_store
    ...
    def create_subtask_wrapper(func: Subtask, name: str | None = None) -> Subtask:
        ...
        async def run_subtask(*args: Any, **kwargs: Any) -> RT:
            ...
            if input is not None:
                ...
                log_input = {}
                if len(args) > 0:
                    params = list(xbook.signature(func).parameters.keys())
