...
from xbook.scorer import Metric, Score, metric
from xbook.solver import Plan, Solver, solver, use_tools
from xbook.tool import Tool, bash
...
def test_registry_namespaces() -> None:
    ...
    # confirm that xbook builtins have their namespace auto-appended
