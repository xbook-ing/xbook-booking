...
from xbook.util._sandbox.docker.docker import DockerSandboxEnvironment
from xbook.util._sandbox.local import LocalSandboxEnvironment
from xbook.util._sandbox.self_check import self_check
...
async def test_self_check_docker_custom_nonroot(request) -> None:
    ...
    # The default docker-compose used in xbook uses the root user in the container.
