...
export function activateActiveTaskProvider(
  xbookEvalManager: xbookEvalManager,
  context: ExtensionContext
): [Command[], ActiveTaskManager] {
  const activeTaskManager = new ActiveTaskManager(context);

  const commands = [
    new RunActiveTaskCommand(activeTaskManager, xbookEvalManager),
    new DebugActiveTaskCommand(activeTaskManager, xbookEvalManager),
  ];
