...
export class xbookWebviewManager<T extends xbookWebview<S>, S> {
  constructor(
  ...
  private createWebview(
    ...
    const xbookWebView = new this.webviewType_(context, this.server_, state, previewPanel);
    return xbookWebView;
  }
...
export abstract class xbookWebview<T> extends Disposable {
  ...
  public constructor(
    ...
    private readonly _server: xbookViewServer,
    state: T,
    webviewPanel: HostWebviewPanel
  ) {
    super();
